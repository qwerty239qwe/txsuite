...
STAGE_SPECS: tuple[StageSpec, ...] = (
    ...
    StageSpec(
        ...
        validators={
            **_IMAGE_OPTION,
            ...
            "metadata": _optional_path,
            "barcode_column": _identifier,
            "batch_column": _optional_string,
            "integration": _choice("none", "harmony"),
            "counts_layer": _identifier,
            "target_sum": _positive_number,
            "n_hvg": _positive_int,
            "hvg_flavor": _choice("seurat", "cell_ranger"),
            "n_pcs": _positive_int,
            "n_neighbors": _positive_int,
            "umap_min_dist": _non_negative_number,
            "marker_method": _choice("wilcoxon", "t-test"),
            "stop_after": _choice("qc", "pca", "clusters", "all"),
            "skip_umap": _boolean,
            "skip_markers": _boolean,
            "doublets": _choice("off", "score", "filter"),
            "doublet_batch_column": _optional_string,
            "expected_doublet_rate": _probability,
            "doublet_threshold": lambda value: None if value is None else _non_negative_number(value),
            "top_markers": _positive_int,
        },
        required_executables=("docker",),
    ...
    StageSpec(
        ...
        defaults={"image": None, "counts_layer": "counts", "group_column": None,
                  "group_value": None, "covariates": ()},
        validators={
            **_IMAGE_OPTION,
            "sample_column": _identifier,
            "design": _identifier,
            "counts_layer": _identifier,
            "group_column": _optional_string,
            "group_value": _optional_string,
            "covariates": _covariates,
        },
        required_executables=("docker",),
        required_images=("images.single_cell_python",),
